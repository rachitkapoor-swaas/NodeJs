...
<form action="" method='post'>
    ...
    <?php
        ...
        $array = array("option1"=>"The IP address of the client",
                    "option2"=>"The HTTP method used for the request (GET, POST, etc.)",
                    "option3"=>"The server's operating system",
                    "option4"=>"The server's hostname"
                    );
